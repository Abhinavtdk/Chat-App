...
class MyFirebaseMessaging : FirebaseMessagingService() {
    ...
    private fun sendNotification(mRemoteMessage: RemoteMessage) {
        ...
        val defaultSonud = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
    ...
    private fun sendOreoNotification(mRemoteMessage: RemoteMessage) {
        ...
        val builder: Notification.Builder = oreoNotification.getOreoNotification(title,body,pendingIntent,defaultSonud,icon)
